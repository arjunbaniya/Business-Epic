...
if ( !function_exists('business_epic_dynamic_css') ):
    ...
    ";
            ...
            $custom_css .= ".service-icon .fa , h5.clientname,.main-header .site-title a, .leavecomment a,.widget-inner-title a:hover,
    ...
    ";
        ...
        $custom_css .= ".service-icon div, .widget-ample-business-theme-counter, .portfolioFilter .current, .portfolioFilter a:hover, .paralex-btn:hover, .view-more:hover, .features-slider .owl-theme .owl-controls .owl-page.active span, .widget-ample-business-theme-testimonial .owl-theme .owl-controls .owl-page.active span, .read-more-background, .widget-ample-business-theme-testimonial, .widget-ample-business-theme-meetbutton, .footer-tags a:hover, .ample-inner-banner, .breadcrumbs, .widget-search .search-submit:hover, .posts-navigation .nav-previous, .posts-navigation .nav-next, .pagination-blog .pagination > .active > a, .pagination-blog .pagination > li > a:hover, .scrollup ,.widget_search .search-submit 
    
 {
    ...
    ";
        $custom_css .= ".error404 .content-area .search-form .search-submit{
