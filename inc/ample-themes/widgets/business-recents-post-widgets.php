...
if (!class_exists('Business_Recent_Post_Widget')) {
    class Business_Recent_Post_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'cat_id' => 0,
                'title' => esc_html__('Latest Blogs', 'business-epic'),
                'sub-title' => '',
        ...
        public function __construct()
        {
            parent::__construct(
                ...
                esc_html__('Business Recent Post Widget', 'business-epic'),
                array('description' => esc_html__('Business Recent Post Section', 'business-epic'))
            );
        }
        ...
        public function form($instance)
        {
            ...
            <p>
                ...
                $business_con_dropown_cat = array(
                    'show_option_none' => esc_html__('From Recent Posts', 'business-epic'),
                    'orderby' => 'name',
                    'order' => 'asc',
                    'show_count' => 1,
                    'hide_empty' => 1,
                                                ...
                                                <div class="blog-details">
                                                    <header class="entry-header">
                                                        ...
                                                        <a href="<?php comments_link(); ?>" rel="">
                                                            ...
                                                            <time class="entry-date published" datetime="">Leave a comment</time>
                                                        </a>
                                                        </span>
                                                        </div>
...
add_action('widgets_init', 'business_recent_post_widget');
function business_recent_post_widget()
{
    register_widget('Business_Recent_Post_Widget');
